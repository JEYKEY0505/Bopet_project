...
const primero= jugadores(elementos)
const segundo= jugadores(elementos)
function construir(){
    let elementos= {}
    for(let i=0; i<5; i++){
        let fila=[]
...
function jugadores(elementos){
    let contador=0
    let mundo={}
    for(let i=0; i<5; i++){
        for(let j=0; j<5 ; j++){
            mundo[contador]= elementos[i][j]
            contador+=1
        }
    }
    return mundo
            ...
            for(let i=0; i<5; i++){
                for(let j=0; j<5; j++){
                    ...
                    if(valor==3 && grupo[i][j]!=undefined){
                        this.secuencia.push(grupo[indices])
                        this.indices[contador]= indices
                        contador+=1
                    }
                    indices+=1
                    if(contador==ronda){
